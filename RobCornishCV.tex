...
\begin{entrylist}
    \entry
        ...
        {Cofounder \& director}
        {Proof Relevant}
        {Cofounded with Prof.\ Sam Staton (Oxford), Prof.\ Jamie Vicary (Cambridge), and Younesse Kaddar (Oxford), Proof Relevant combines techniques from logic and formal methods with agents and large language models to provide the best of both worlds: the creativity and flexibility of modern AI, with the guarantees of mathematical proof. We are currently in early stages and exploring applications and partnerships in the financial space. We are an early-stage member of the CommonAI CIC.}

    \entry
        {2018 -- 2025}%\\\footnotesize{part time}}
        {Cofounder, director (2018-2025), \& CTO/CSO (2018-2021)}
        {Quro Medical}
        ...
        Quro has successfully treated large numbers of patients with a variety of medical conditions, including many with COVID-19 during the pandemic.
        Financing includes rounds totalling \$1.1M USD in 2021 (Enza Capital and Mohau Equity Partners), an undisclosed amount in 2022 (Life Healthcare), \$1.4M USD in 2023 (MIC Khulisani), and \$7.1M USD in 2025 (Netcare).
...
\begin{entrylist}
    \entry
        ...
        {\textit{Australian Category Theory Seminar}}
    \entry
        {February 2026}
        {Stochastic Neural Network Symmetrisation in Markov Categories}
        {Online (hosted by University of Warwick)}
        {\textit{Compositional Foundations seminar series}}
    \entry
        {June 2025}
        {Stochastic Neural Network Symmetrisation in Markov Categories}
        {Quantinuum}
        {\textit{Compositional Intelligence team seminar series}}
    \entry
        {May 2025}
        {Stochastic Neural Network Symmetrisation in Markov Categories}
        {University of Oxford}
...
\begin{entrylist}
    \entry
        {2025-2026 \\ \footnotesize{Semester 2}}
        {Lecturer}
        {CCDS, Nanyang Technological University}
        {Taught half of Linear Algebra for Computing (SC1004)}
