...
\begin{entrylist}
  ...
  \entry
    ...
    {University of Melbourne}
    {Equivalent to a full major in Pure Mathematics within the BSc}
  \entry
    {2010 -- 2012}
    {Bachelor of Arts}
    {University of Melbourne}
...
Even within the context of academic research, I believe it is important to be as familiar as possible with low-level, practical details of current and emerging technologies. %, since there are many problems that only become visible at this level.
